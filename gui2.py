...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "L1"))
        self.label_10.setText(_translate("MainWindow", "L2"))
        self.label_8.setText(_translate("MainWindow", "L3"))
        self.label_9.setText(_translate("MainWindow", "L4"))
        self.label_11.setText(_translate("MainWindow", "L5"))
        self.label_12.setText(_translate("MainWindow", "L6"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("MainWindow", "Servo"))
        # Set Servo Slider to zero
        #self.horizontalSlider_7.valueChanged['int'].connect(self.servo)
        #self.horizontalSlider_7.sliderMoved['int'].connect(self.servo)
        ...
        self.spinBox_7.valueChanged["int"].connect(self.servo)
        self.spinBox_8.valueChanged["int"].connect(self.servo)
        self.spinBox_9.valueChanged["int"].connect(self.servo)
        self.spinBox_10.valueChanged["int"].connect(self.servo)
        self.spinBox_11.valueChanged["int"].connect(self.servo)
        self.spinBox_12.valueChanged["int"].connect(self.servo)
    ...
    def servo_init(self):
        ...
        self.executor.add_node(node)
        node.create_timer(0.01,self.servo)
    def servo(self):
